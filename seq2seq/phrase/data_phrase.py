...
def process_data():
    ...
    np.save('idx_q_phra.npy', idx_q)
    np.save('idx_a_phra.npy', idx_a)
    np.save('idx_o_phra.npy', idx_o)
    ...
    with open('metadata_p.pkl', 'wb') as f:
        pickle.dump(metadata, f)


def load_data(path=''):
    with open(path + 'metadata_p.pkl', 'rb') as f:
        metadata = pickle.load(f)
    idx_q = np.load(path + 'idx_q_phra.npy')
    idx_a = np.load(path + 'idx_a_phra.npy')
